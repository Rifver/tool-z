...
const Services = () => {
  const services = [{
    ...
    features: ['Multi-camera setups', 'Professional lighting', 'Green screen production', 'Event documentation', 'Corporate videos'],
    price: 'Custom Quote'
  }, {
    icon: Edit3,
    title: 'Video Editing & Post-Production',
    description: 'Comprehensive video editing services using industry-standard software to bring your vision to life.',
    features: ['Adobe Premiere Pro editing', 'Color correction & grading', 'Audio mixing & mastering', 'Transitions & effects', 'Final delivery in multiple formats'],
    ...
    features: ['After Effects animation', 'Logo animations', 'Text overlays & titles', 'Visual effects (VFX)', 'Basic 3D animations'],
    ...
    features: ['Content planning', 'Storyboard creation', 'Visual storytelling guidance', 'Trend analysis', 'Brand video strategies'],
      ...
      <div className="pt-24 pb-12">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">Professional videography and editing skills to bring your creative vision to life</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            ...
            return <div key={index} className="glass-card p-8 hover:scale-105 transition-all duration-300">
          ...
          <div className="mb-16">
            <h2 className="text-3xl font-display font-bold text-center mb-8">
              Additional <span className="portfolio-gradient bg-clip-text text-transparent">Skills</span>
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {addOnServices.map((addon, index) => {
              const Icon = addon.icon;
              return <div key={index} className="glass-card p-6 text-center">
