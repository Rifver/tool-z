...
const Experience = () => {
  const experiences = [{
    ...
    achievements: ['Managed full-cycle video production from concept to final delivery', 'Created engaging content for social media platforms and corporate communications', 'Collaborated with marketing teams to develop visual content strategies', 'Improved video production efficiency by implementing standardized workflows', 'Delivered high-quality videos that increased client engagement by 40%'],
    ...
    achievements: ['Provided technical support for computer lab equipment and software', 'Assisted students with programming assignments and multimedia projects', 'Maintained lab equipment and ensured optimal working conditions', 'Developed teaching materials for multimedia and video editing workshops', 'Mentored students in video editing techniques and software usage'],
    ...
    achievements: ['Captured professional photography for organizational events and campaigns', 'Designed user interface elements for digital platforms', 'Created visual content for social media and marketing materials', 'Learned fundamentals of brand consistency and visual storytelling', 'Contributed to increasing social media engagement through visual content'],
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto mb-16">
            ...
            <div className="space-y-8">
              {experiences.map((exp, index) => <div key={index} className="glass-card p-8 relative">
                  {/* Timeline Line */}
                  {index < experiences.length - 1 && <div className="absolute left-4 top-16 w-0.5 h-full bg-primary/30"></div>}
                  ...
                  <div className="ml-8">
                    ...
                    <div className="mb-4">
                      ...
                      <ul className="space-y-1">
                        {exp.achievements.map((achievement, achIndex) => <li key={achIndex} className="text-sm text-muted-foreground flex items-start">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {exp.skills.map((skill, skillIndex) => <span key={skillIndex} className="px-3 py-1 bg-secondary/50 text-xs rounded-full text-muted-foreground">
                          {skill}
                        </span>)}
                    </div>
                  </div>
